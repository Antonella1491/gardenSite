    document.addEventListener("DOMContentLoaded", () => {
      ...
      sendBtn.onclick = async () => {
        ...
        chatBox.innerHTML += `<p id="waitingMsg" style="color:#ccccc;"><strong>Bot:</strong> Sto pensando...</p>`;
        chatBox.scrollTop = chatBox.scrollHeight;

        try {
          // Cambia l'URL e metodo con il tuo endpoint reale
          const res = await fetch("https://replit.com/@antodolcebimba/chatbot-gpt", {
            method: "POST",
